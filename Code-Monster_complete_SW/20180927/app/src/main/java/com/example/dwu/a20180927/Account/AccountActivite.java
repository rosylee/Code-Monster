...
public class AccountActivite extends AppCompatActivity {
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(AccountActivite.this, AccountEnglish.class);
                    intent.putExtra(AccountEnglish.ACCOUNT_SOUND_NUMBER, pposition);
                    AccountActivite.this.startActivity(intent);
                }
            };
}
