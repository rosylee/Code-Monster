...
public class CardActivityv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardv);
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(CardActivityv.this, CardVietnamese.class);
                    intent.putExtra(CardChinese.ACCOUNT_SOUND_NUMBER, pposition);
                    CardActivityv.this.startActivity(intent);
                }
            };
}
