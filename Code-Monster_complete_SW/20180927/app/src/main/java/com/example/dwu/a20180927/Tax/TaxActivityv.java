...
public class TaxActivityv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taxv);
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(TaxActivityv.this, TaxVietnamese.class);
                    intent.putExtra(TaxVietnamese.ACCOUNT_SOUND_NUMBER, pposition);
                    TaxActivityv.this.startActivity(intent);
                }
            };
}