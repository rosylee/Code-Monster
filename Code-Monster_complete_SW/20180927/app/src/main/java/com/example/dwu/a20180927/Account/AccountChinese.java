...
public class AccountChinese extends AppCompatActivity {
    ...
    private static final int[] soundTrakcs = new int[]{ R.raw.account01, R.raw.account02, R.raw.account03,
        R.raw.account04, R.raw.account05, R.raw.account06, R.raw.account07, R.raw.account08, R.raw.account09, R.raw.account10,
        R.raw.account11, R.raw.account12};
    ...
    private static final int[] textChTracks = new int[] {
            R.string.account_1_ch, R.string.account_2_ch, R.string.account_3_ch, R.string.account_4_ch,
            R.string.account_5_ch, R.string.account_6_ch, R.string.account_7_ch, R.string.account_8_ch, R.string.account_9_ch,
            R.string.account_10_ch, R.string.account_11_ch, R.string.account_12_ch
    };//해석

    private static final int[] textChTracks2 = new int[]{
            R.string.account_1_ch2,R.string.account_2_ch2,R.string.account_3_ch2,R.string.account_4_ch2,
            R.string.account_1_ch2,R.string.account_2_ch2,R.string.account_3_ch2,R.string.account_4_ch2,
            R.string.account_1_ch2,R.string.account_2_ch2,R.string.account_3_ch2,R.string.account_4_ch2
    };//해설
