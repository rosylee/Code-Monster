...
public class LoanActivityv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loansv);
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(LoanActivityv.this, LoanVietnamese.class);
                    intent.putExtra(LoanVietnamese.ACCOUNT_SOUND_NUMBER, pposition);
                    LoanActivityv.this.startActivity(intent);
                }
            };
}
