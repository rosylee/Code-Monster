...
public class ah_Product implements Serializable {
    ...
    public ah_Product(long _id, String bank, String title, String info, String type, String user, String amount, Double rate, String term){
        this._id = _id;
        this.bank = bank;
        this.title = title;
        this.info = info;
