...
public class ah_InstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ahProductList = new ArrayList<ah_Product>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ah_InstActivity.this, ah_InstDetailActivity.class);
                intent.putExtra("id", id);
                ah_InstActivity.this.startActivity(intent);
            }
        });
