...
public class InvestmentChinese extends AppCompatActivity {
    ...
    private static final int[] soundTrakcs = new int[]{ R.raw.account01, R.raw.account02, R.raw.account03,
        R.raw.account04, R.raw.account01, R.raw.account02
    };
    ...
    private static final int[] textChTracks = new int[] {
            R.string.invest_1_ch, R.string.invest_2_ch, R.string.invest_3_ch, R.string.invest_4_ch,R.string.invest_5_ch,R.string.invest_6_ch
    };//해석

    private static final int[] textChTracks2 = new int[]{
            R.string.invest_1_ch2, R.string.invest_2_ch2, R.string.invest_3_ch2, R.string.invest_4_ch2,R.string.invest_5_ch2,R.string.invest_6_ch2
    };//해설
