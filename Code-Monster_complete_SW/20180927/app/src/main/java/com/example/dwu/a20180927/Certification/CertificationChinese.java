...
public class CertificationChinese extends AppCompatActivity {
    ...
    private static final int[] textChTracks = new int[] {
            R.string.cert_1_ch, R.string.cert_2_ch, R.string.cert_3_ch, R.string.cert_4_ch
    };//해석

    private static final int[] textChTracks2 = new int[]{
            R.string.cert_1_ch2,R.string.cert_2_ch2,R.string.cert_3_ch2,R.string.cert_4_ch2
    };//해설
