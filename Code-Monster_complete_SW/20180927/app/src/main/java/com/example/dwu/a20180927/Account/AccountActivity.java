...
import android.widget.ListView;import com.example.dwu.management.R;
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(AccountActivity.this, AccountChinese.class);
                    intent.putExtra(AccountChinese.ACCOUNT_SOUND_NUMBER, pposition);
