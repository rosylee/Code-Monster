...
public class TaxActivitye extends AppCompatActivity {
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(TaxActivitye.this, TaxEnglish.class);
                    intent.putExtra(TaxEnglish.ACCOUNT_SOUND_NUMBER, pposition);
                    TaxActivitye.this.startActivity(intent);
                }
            };
}