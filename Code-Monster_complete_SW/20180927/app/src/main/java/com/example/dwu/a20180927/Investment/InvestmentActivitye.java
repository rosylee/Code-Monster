...
public class InvestmentActivitye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_investmente);
    ...
    AdapterView.OnItemClickListener itemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long ld) {
                    ...
                    Intent intent = new Intent(InvestmentActivitye.this, InvestmentEnglish.class);
                    intent.putExtra(InvestmentEnglish.ACCOUNT_SOUND_NUMBER, pposition);
                    InvestmentActivitye.this.startActivity(intent);
                }
            };
}
