...
public class AccountVietnamese extends AppCompatActivity {
    ...
    private static final int[] soundTrakcs = new int[]{ R.raw.account01v, R.raw.account02v, R.raw.account03v,
        R.raw.account04v, R.raw.account05v, R.raw.account10v, R.raw.account07v, R.raw.account08v, R.raw.account09v, R.raw.account10v,
    ...
    private static final int[] textVTracks = new int[] {
            ...
            R.string.account_5_v, R.string.account_6_v, R.string.account_3_v, R.string.account_2_v, R.string.account_1_v,
            R.string.account_2_v, R.string.account_3_v, R.string.account_4_v
    };//해석
    private static final int[] textVTracks2 = new int[]{
            ...
            R.string.account_5_v2,R.string.account_6_v2,R.string.account_7_v2,R.string.account_8_v2,
            R.string.account_1_v2,R.string.account_2_v2,R.string.account_3_v2,R.string.account_4_v2
