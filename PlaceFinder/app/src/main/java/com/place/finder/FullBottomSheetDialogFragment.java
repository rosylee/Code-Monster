...
public class FullBottomSheetDialogFragment extends BottomSheetDialogFragment implements OnMapReadyCallback {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view = View.inflate(getContext(), R.layout.sheet, null);
        ...
        TextView oldAddress = view.findViewById(R.id.place_old_address);
        ...
        address.setText(bank.newAddress);
        oldAddress.setText(bank.oldAddress);
