...
public class SplashActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String sns = Utility.get(this, "sns");

        if(!sns.isEmpty()) {
            UserManager.getInstance().setType(sns);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RC_SIGN_IN) {
            ...
            UserManager.getInstance().setType("Google");
            Utility.set(this, "sns", "Google");
        }
    ...
    protected void redirectSignupActivity() {
        UserManager.getInstance().setType("KakaoTalk");
        Utility.set(this, "sns", "KakaoTalk");
        finish();
        final Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
